                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 px-lg-5 mb-4 mb-lg-0">
                            ...
                            <p className="footer_text">
                                <a >cardelarship@gmail.com</a><br />
                                <a className="footer-address">South Ural state University <br />Chelyabinsk , Russia</a>
                            </p>
                        </div>
                        ...
                        <div className="col-12 footer_credits text-center">
                            <span>© 2025 <a>carwale</a>™. All Rights Reserved.</span>
                        </div>
                    </div>
                </div>
            </section >
